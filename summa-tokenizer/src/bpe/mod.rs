// The extracted engine retains alternate architecture and tokenizer-family
// paths so upstream refreshes stay reviewable. A given build uses only a
// subset of them.
...
// Re-export the byte-level engine inside the extracted core.
