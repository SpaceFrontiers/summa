...
async fn impact_pruning_preserves_canonical_score_sums_for_wide_boolean_queries() {
    ...
    for arity in [1, 2, 7, 16, 31, 64] {
        for required in [0, 1, arity] {
            ...
            let mut all = TopKCollector::new(4096);
